...
* Open an Issue at https://github.com/CorentinTh/cauctus/issues
...
* Go to https://github.com/CorentinTh/cauctus/pulls and open a new pull request with your changes.
...
* Barring special circumstances, maintainers will not review PRs until all checks pass (CI, Github actions).
* One or more maintainers will use GitHub's review feature to review your PR.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/CorentinTh/cauctus/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
In order to label issues, [open up the list of unlabeled issues](https://github.com/CorentinTh/cauctus/issues?q=is%3Aopen+is%3Aissue+no%3Alabel) and, **from newest to oldest**, read through each one and apply issue labels according to the table below. If you're unsure about what label to apply, skip the issue and try the next one: don't feel obligated to label each and every issue yourself!
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/CorentinTh/cauctus/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
...
* *ALL PULL REQUESTS* should have all checks passing (CI, Github actions). Be sure to have check the linter (npm run lint) is passing, and the application is correctly building. 
* Please make sure you're familiar with the code or documentation being updated, unless it's a minor change (spellchecking, minor formatting, etc). You may @mention another project member who you think is better suited for the review, but still provide a non-approving review of your own.
* Be extra kind: people who submit code/doc contributions are putting themselves in a pretty vulnerable position, and have put time and care into what they've done (even if that's not obvious to you!) -- always respond with respect, be understanding, but don't feel like you need to sacrifice your standards for their sake, either. Just don't be a jerk about it?

## Merge Pull Requests

Pull request are merged using **rebase**, or **squash** if several commits are covering the same scope.
